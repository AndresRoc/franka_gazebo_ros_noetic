#!/usr/bin/python3.8
"""
    From original repository https://github.com/mkrizmancic/franka_gazebo
    By:
        Marko Križmančić
        Research Associate at Faculty of Electrical Engineering and Computing, University of Zagreb
    github: 
        mkrizmancic (https://github.com/mkrizmancic)
    Use this to replicate original behavior
"""
import rospy
import math
